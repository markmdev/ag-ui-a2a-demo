...
import { createSystemPrompt, sendMessageToA2AAgentTool } from "./a2a-middleware-utils";
              ...
              const callProms = [...pendingA2ACalls].map((toolCallId) => {
                ...
                return this.sendMessageToA2AAgent(agentName, task)
                  .then((a2aResponse) => {
                    ...
                    // 🔧 FIX: Collect the message so we can add it to input.messages
